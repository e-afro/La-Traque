...
/**
 * Write a description of class Verif here.
 * 
 * @author DB 
...
//     public static boolean verifModConstructor( final ConstructorContent pC, final String pYes, final String pNo )
// 
//     public static MethodContent uneMethode( ClassContent pCla, String pName )
...
//     public static boolean verifModMethod( final MethodContent pC, final String pYes, final String pNo )
// 
...
//     public static String verifFinal( String pFil, String pMet ) // premier parametre
//     public static String verifFinal2( String pFil, String pMet  ) // 2eme parametre
// 
// //     private static String myReplace( final String pMes, final String pFrom, final String pTo )
    ...
    private static String sNature /*= null*/;
    private static String sClasse /*= null*/;
    private static String sType /*= null*/;
    private static String sNom /*= null*/;
    private static Object sRetour /*= null*/;
...
//     @Test public static void         verifClaY( String pGood )
//     @Test public static void         verifClaYN( String pGood, String pBad )
...
//         vrai( vAttr.isPrivate(), "$a $n n'est pas prive !" );
    ...
    public static FieldContent getAttFTN( ClassContent pCla, String pType, String pName )
    {
          ...
          if (vRetour != null) {
              ...
              sMes = "$a $n n'est pas de type $t ("+pType+") !";
              sType = pType;
          }
        return vRetour;
    } // getAttFTN(...)
...
//         failIfNot();
    ...
    public static void verifDefCon( final ClassContent pCla, final String pExist )
    {
        ...
        String vMessage = ( vWanted
          ? "n'existe pas ou bien auriez-vous ecrit un \"mauvais\" constructeur ?"
...
// ===== methodes =====zmet
    ...
    public static MethodContent getVMetFProto( final ClassContent pCla, final String pMethod, final String pRT, final String pProto )
    {
        ...
        verifModMet( vMet, "public", "static final" );
        return vMet;
    } // getVMetFProto(....)
